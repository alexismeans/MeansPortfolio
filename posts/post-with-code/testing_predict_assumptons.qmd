...
The stars indicate that it has both a low R-Squared value as well as it predicting low biomass for high percent cover in at least one instance.
...
Here are the updated R-squared, AIC, and Coeffecient values of the used regression equations that include an interaction term between various transformations of Julian Day and Percent cover. Ryan helped me code the interaction term into the dredging model, so every combination should have been considered.
